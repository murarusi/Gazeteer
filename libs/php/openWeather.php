...
$url ="https://api.openweathermap.org/data/2.5/onecall?lat=" . $_REQUEST['lat'] . "&lon=" . $_REQUEST['lon'] . "&ctn=4&units=metric&exclude=alerts,hourly,current,minutely"  . "&appid=" . $apiKey;
